...
- `bun run desktop:dev` launches the Vite frontend and native Tauri application.
- `bun run frontend:typecheck`, `bun run frontend:lint`, `bun run frontend:test`, and `bun run frontend:build` validate the desktop frontend.
